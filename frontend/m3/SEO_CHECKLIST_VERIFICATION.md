...
*Nota: Aunque algunos items están marcados como `MANUAL` en la definición de tipos, el frontend está preparado para recibir y mostrar `autoData` (datos automáticos) para todos ellos si el backend los provee.*
