  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 pb-20">
      <div className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        <h2 className="mb-6 flex items-center text-xl font-bold text-slate-800">Credenciales API</h2>
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">Necesaria para obtener resultados reales de Google News. Las claves de IA (Gemini/OpenAI) se gestionan exclusivamente en backend.</p>
          </div>
        </div>
      </div>
