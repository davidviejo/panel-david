            ...
            >
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onBlur={(e) =>
                    onUpdateTaskNotes(item.moduleId, item.task.id, e.target.value)
                  }
                />
              </div>
              ...
              {learningMode && (
                <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-900 rounded-lg p-3 text-xs text-slate-600 dark:text-slate-300 mb-4 flex gap-3">
                  ...
                  <div>
                    ...
                    Dominar esta tarea es crucial para el éxito de tu estrategia SEO en
                    el módulo {item.moduleId}.
                  </div>
                </div>
              )}
              ...
              <div className="flex gap-3 flex-wrap items-center">
                ...
                {item.task.status === 'completed' && (
                  <button
                    onClick={() =>
                      onToggleTaskCommunicated(item.moduleId, item.task.id)
                    }
