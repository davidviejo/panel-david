...
from apps.scraping.scraper_core import fetch_url_hybrid, get_optimized_headers, parse_google_html
...
@patch('apps.scraping.scraper_core.requests.get')
...
@patch('apps.scraping.scraper_core.requests.get')
@patch('apps.scraping.scraper_core.get_browser')
