...
from apps.scraping.scraper_core import _fetch_with_requests, _fetch_with_playwright
...
class TestSecurityBasic(unittest.TestCase):
    ...
    def test_scraper_core_requests_error_suppression(self):
        with patch('apps.scraping.scraper_core.requests.get') as mock_get:
    ...
    def test_scraper_core_playwright_error_suppression(self):
        with patch('apps.scraping.scraper_core.get_browser') as mock_browser:
