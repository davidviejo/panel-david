...
sys.modules['apps.web'] = MagicMock()
sys.modules['apps.web.blueprints'] = MagicMock()
sys.modules['apps.web.blueprints.usage_tracker'] = MagicMock()
sys.modules['apps.web.blueprints.seo_tool'] = MagicMock()
