...
def run_orchestrated_checklist(
    ...
    schema_res_block = _analyze_structured_data_detailed(soup, schema_data)
...
def _analyze_structured_data_detailed(soup, schema_data_tool):
    # Base from tool
    if check_dependency_error(schema_data_tool):
